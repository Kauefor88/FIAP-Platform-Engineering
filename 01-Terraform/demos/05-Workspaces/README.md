...
| [Parte 3](#parte-3---validando-com-terraform-test) | Validando a configuração com `terraform test` | [14](#passo-14) · [15](#passo-15) · [16](#passo-16) | ~8 min |
...
- destruiu a EC2 do `dev` — nenhuma instância `vortex-*` ficou rodando
